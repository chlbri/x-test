...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    'done.invoke.fetchNews.environment.API_KEY:invocation[0]': {
      type: 'done.invoke.fetchNews.environment.API_KEY:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.fetchNews.environment.API_URL:invocation[0]': {
      type: 'done.invoke.fetchNews.environment.API_URL:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.json': {
      type: 'done.invoke.json';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.zod': {
      type: 'done.invoke.zod';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'error.platform.fetch': {
      type: 'error.platform.fetch';
      data: unknown;
    };
    'error.platform.fetchNews.environment.API_KEY:invocation[0]': {
      type: 'error.platform.fetchNews.environment.API_KEY:invocation[0]';
      data: unknown;
    };
    'error.platform.fetchNews.environment.API_URL:invocation[0]': {
      type: 'error.platform.fetchNews.environment.API_URL:invocation[0]';
      data: unknown;
    };
